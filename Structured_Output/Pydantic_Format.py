...
class StructuredOutput(BaseModel):
    ...
    key_themes:list[str] = Field(..., description="List of key themes or topics mentioned in the review")
    pros:Optional[list[str]] = Field(None, description="List of positive aspects mentioned in the review")
    cons:Optional[list[str]] = Field(None, description="List of negative aspects mentioned in the review")
